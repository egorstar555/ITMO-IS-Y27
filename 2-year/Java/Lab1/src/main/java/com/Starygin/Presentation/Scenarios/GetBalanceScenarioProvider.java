...
public class GetBalanceScenarioProvider implements ScenarioProvider {
    private final UserService userService;

    private final CurrentUserService currentUserService;

    public GetBalanceScenarioProvider(UserService userService, CurrentUserService currentUserService) {
    ...
    public Scenario tryGetScenario() {
        ...
        return new GetBalanceScenario(userService);
    }
}
