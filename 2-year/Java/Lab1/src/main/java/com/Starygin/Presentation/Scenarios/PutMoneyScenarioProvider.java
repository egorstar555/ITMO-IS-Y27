...
public class PutMoneyScenarioProvider implements ScenarioProvider {
    private final UserService userService;

    private final CurrentUserService currentUserService;

    public PutMoneyScenarioProvider(UserService userService, CurrentUserService currentUserService) {
    ...
    public Scenario tryGetScenario() {
        ...
        return new PutMoneyScenario(userService);
    }
}
