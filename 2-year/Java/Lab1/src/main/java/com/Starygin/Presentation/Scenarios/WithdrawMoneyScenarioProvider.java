...
public class WithdrawMoneyScenarioProvider implements ScenarioProvider {
    private final UserService userService;

    private final CurrentUserService currentUserService;

    public WithdrawMoneyScenarioProvider(UserService userService, CurrentUserService currentUserService) {
    ...
    public Scenario tryGetScenario() {
        ...
        return new WithdrawMoneyScenario(userService);
    }
}
